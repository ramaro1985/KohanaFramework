...
Reportes.PlanProduccion.GestionPlanProduccion = Ext.extend(Ext.Panel, {
    ownerModule : null,
    desktop : null,
    formulario : null,
    constructor : function(config) {
        ...
        this.actions = {
            'GestionPlanProduccion' : function(ownerModule){
                ownerModule.viewCard('PlanProduccion');
            }
        };
        ...
        var store_productos = new Ext.data.JsonStore({  
            url: 'planProduccion/nombre_productos_plan_consumo',  
            root: 'data',
            fields: ['codigo','id_producto','nombre','descripcion','um','plan_prod_real','cant_lab','cant_almacen','existencia_total'],
        ...
        var store_materias_primas_productos = new Ext.data.JsonStore({  
            url: 'planProduccion/materias_primas_producto_plan_consumo',  
            root: 'data',
            fields: ['codigo','id_producto','nombre','descripcion','um','cant_utilizar','cant_lab','cant_almacen','existencia_total','total_final']
        });
        var store_cantidad_mp_nec = new Ext.data.JsonStore({  
            url: 'planProduccion/cantidad_mp_nec_plan_consumo',  
            root: 'data',
            fields: ['codigo','id_producto','nombre','descripcion','um','cant_elab','plan_prod_real','cant_lab','cant_almacen','existencia_total']
        });
        function descripcion(val, x, store_productos){
            return '<b>'+val+'</b><br>'+store_productos.data.descripcion;
        }
       ...
       //var aa = Ext.getCmp('mp').getSelectionModel().getSelected().data.nombre;
       /* var total = new Ext.form.NumberField({
        ...
        Reportes.PlanProduccion.GestionPlanProduccion.superclass.constructor.apply(this, [config]);
    }
});
