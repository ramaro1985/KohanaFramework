...
Extop.Demo.BogusWindow = Ext.extend(Ext.app.Module, {
   id: 'demo-bogus',
   type: 'demo/bogus',
   detailModule: null,
   ...
   createWindow: function () {
      ...
      if (!win) {
         this.navPanel = new Extop.Demo.BogusWindow.NavPanel({
            id: 'nav-panel',
            owner: this,
            region: 'center'
         });
...
Extop.Demo.BogusWindow.NavPanel = function (config) {
   this.owner = config.owner;

   Extop.Demo.BogusWindow.NavPanel.superclass.constructor.call(this, {
      autoScroll: true,
...
Ext.extend(Extop.Demo.BogusWindow.NavPanel, Ext.Panel, {
   afterRender: function () {
      ...
      Extop.Demo.BogusWindow.NavPanel.superclass.afterRender.call(this); // do sizing calcs last
   },
