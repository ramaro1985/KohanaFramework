...
If you need you may include a regular Kohana View file by placing the name of the view in double curly brackets.  **If the view is not found, an error or exception will be shown.**

	{{userguide/examples/markdown}}
