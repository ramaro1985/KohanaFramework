...
/**
 * Service_Container_Dumper_Xml dumps a service container as an XML string.
 *
 * @package    Kohana/IOC
 ...
 * @version    SVN: $Id$
 */
class Service_Container_Dumper_Xml extends Service_Container_Dumper
{
  /**
  ...
  protected function convertParameters($parameters, $type='parameter', $depth = 2)
  {
    ...
    foreach ($parameters as $key => $value)
    {
      ...
      if (is_object($value) && $value instanceof Service_Reference)
      {
...
EOF;
  ...
  static public function phpToXml($value)
  {
    switch (true)
    {
      ...
      case false === $value:
        return 'false';
      case is_object($value) && $value instanceof Service_Parameter:
        return '%'.$value.'%';
