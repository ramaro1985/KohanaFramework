...
/**
 * Service_Container_Dumper_Graphviz dumps a service container as a graphviz file.
 *
 ...
 * @version    SVN: $Id$
 */
class Service_Container_Dumper_Graphviz extends Service_Container_Dumper
{
  ...
  protected function findEdges($id, $arguments, $required, $name)
  {
    ...
    {
      if (is_object($argument) && $argument instanceof Service_Parameter)
      {
      ...
      if ($argument instanceof Service_Reference)
      {
  ...
  protected function findNodes()
  {
    ...
    foreach ($container->getServiceDefinitions() as $id => $definition)
    {
      ...
      $container->setServiceDefinition($id, new Service_Definition('stdClass'));
    }
