...
/**
 * Service_Container_Loader is the abstract class used by all built-in loaders.
 *
 * @package    Kohana/IOC
 * @subpackage dependency_injection
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @modified   Rafael E. Espinosa Santiesteban <alvk4r@blackbird.org> 
 * @version    SVN: $Id: Service_Container_Loader.php 267 2009-03-26 19:56:18Z fabien $
 */
abstract class Service_Container_Loader implements Service_Container_Loader_Interface
{
  protected $container;
   ...
   * Constructor.
   *
   * @param Service_Container_Builder $container A Service_Container_Builder instance
   */
  public function __construct(Service_Container_Builder $container = null)
  {
   ...
   * @param Service_Container_Builder $container A Service_Container_Builder instance
   */
  public function setServiceContainer(Service_Container_Builder $container)
  {
    $this->container = $container;
  }
   ...
   * $loader = new Service_Container_LoaderXXX($container);
