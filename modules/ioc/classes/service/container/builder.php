...
/**
 * Service_Container_Builder is a DI container that provides an interface to build the services.
 *
 * @package    Kohana/IOC
 * @subpackage dependency_injection
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @modified   Rafael E. Espinosa Santiesteban <alvk4r@blackbird.org> 
 * @version    SVN: $Id: Service_Container_Builder.php 269 2009-03-26 20:39:16Z fabien $
 */
class Service_Container_Builder extends Service_Container
{
  protected
    $definitions = array(),
    $aliases     = array(),
   ...
   *
   * @return Service_Definition A Service_Definition instance
   */
  public function register($id, $class)
  {
    return $this->setServiceDefinition($id, new Service_Definition($class));
  }
   ...
   *
   * @return array An array of Service_Definition instances
   */
   ...
   *
   * @param  string              $id         The service identifier
   * @param  Service_Definition $definition A Service_Definition instance
   */
  public function setServiceDefinition($id, Service_Definition $definition)
  {
    unset($this->aliases[$id]);
   ...
   *
   * @param  Service_Definition $definition A service definition instance
   *
   * @return object              The service described by the service definition
   */
  protected function createService(Service_Definition $definition)
  {
    ...
    {
      if (is_array($callable) && is_object($callable[0]) && $callable[0] instanceof Service_Reference)
      {
  ...
  public function resolveServices($value)
  {
    ...
    else if (is_object($value) && $value instanceof Service_Reference)
    {
