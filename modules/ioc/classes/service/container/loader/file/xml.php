...
/**
 * Service_Container_Loader_File_Xml loads XML files service definitions.
 *
 * @package    Kohana/IOC
 * @subpackage dependency_injection
 * @author     Fabien Potencier <fabien.potencier@symfony-project.com>
 * @modified   Rafael E. Espinosa Santiesteban <alvk4r@blackbird.org> 
 * @version    SVN: $Id: Service_Container_Loader_File_Xml.php 267 2009-03-26 19:56:18Z fabien $
 */
class Service_Container_Loader_File_Xml extends Service_Container_Loader_File
{
  /**
  ...
  protected function parseDefinition($service, $file)
  {
    ...
    $definition = new Service_Definition((string) $service['class']);
    ...
    if (isset($service->configurator))
    {
      ...
      else
      {
        ...
        {
          $class = new Service_Reference((string) $service->configurator['service']);
        }
        else
        {
  ...
  protected function getFilesAsXml(array $files)
  {
    ...
    foreach ($files as $file)
    {
      ...
      $xmls[$path] = simplexml_import_dom($dom, 'Service_Simple_Xml_Element');
    }
