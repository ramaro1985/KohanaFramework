...
/**
 * Service_Container_Loader_File_Yaml loads YAML files service definitions.
 *
 ...
 * @version    SVN: $Id: Service_Container_Loader_File_Yaml.php 269 2009-03-26 20:39:16Z fabien $
 */
class Service_Container_Loader_File_Yaml extends Service_Container_Loader_File
{
  ...
  protected function parseDefinition($service, $file)
  {
    ...
    $definition = new Service_Definition($service['class']);
  ...
  protected function resolveServices($value)
  {
    ...
    {
      $value = new Service_Reference(substr($value, 1));
    }
