...
/**
 * Service_Container_Loader is the abstract class used by all built-in loaders that are file based.
 *
 * @package    Kohana/IOC
 ...
 * @version    SVN: $Id$
 */
abstract class Service_Container_Loader_File extends Service_Container_Loader
{
  protected
    $paths = array();
   ...
   */
  public function __construct(Service_Container_Builder $container = null, $paths = array())
  {
